...
function html5blank_styles() {
    ...
    wp_register_style('html5blank', get_template_directory_uri() . '/style.css', array(), '1.3', 'all');
...
add_action('init', 'gmap_header_scripts'); // Add Custom Scripts to wp_head
...
//         return "projets/bbdsr/wp-admin/edit.php?post_type=page";
//     }
// }
